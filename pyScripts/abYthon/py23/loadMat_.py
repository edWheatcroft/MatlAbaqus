    ...
    def _check_keys(d):
        ...
        for key in d:
            if isinstance(d[key], spio.matlab.mio5_params.mat_struct):
                d[key] = _todict(d[key])
            elif isinstance(d[key], str):     # unicode seems to be implemented differently in python 2
                d[key] = str(d[key])
    ...
    def _todict(matobj):
        ...
        for strg in matobj._fieldnames:
            ...
            if isinstance(elem, spio.matlab.mio5_params.mat_struct):
                ...
                d[strg] = _tolist(elem)
            elif isinstance(elem, str):     # unicode seems to be implemented differently in python 2
                d[strg] = str(elem)
            else:
                d[strg] = elem
        return d
